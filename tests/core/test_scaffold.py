...
def test_every_scaffolded_file_validates_with_zero_errors_sc3(tmp_path: Path) -> None:
    ...
    # No generator writes a root index.md any more (Task 6 retired it; the registry is the one
    # derived file above the topics, T-37), so a freshly scaffolded tree carries no
    # UNEXPECTED_ROOT_ENTRY finding and no finding of any other kind either.
