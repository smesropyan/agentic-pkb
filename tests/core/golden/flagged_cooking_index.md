...
- [Wind shelter](notes/wind-shelter.md) — A windbreak beside the grill · tags: `status.draft` `topic.cooking.grilling` `type.note`
...
- broken-link: `notes/wind-shelter.md` (link target `../references/missing.md` does not exist)
